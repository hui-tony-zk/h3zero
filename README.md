...
- Arrange device-cached results in local-only projects with drag-to-reorder, trimming, speed controls, 0.5-second fade-through-black transitions, sequential preview, and MP4 export
